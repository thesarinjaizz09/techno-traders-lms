...
import { useMembers } from "../hooks/use-forum";
import { channels } from "../utils";

type Member = { name: string; role: string };

export function MembersPanel({ channelId }: { channelId: string }) {
  const { users: onlineUsers } = useOnlineUsers(); // real-time online users
  const { data: membersData, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } = useMembers();
